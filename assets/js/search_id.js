...
function album_id() {
    var input_id = document.getElementById("album_id").innerHTML= `<img  id="albumart1" src="albumart1" alt="artist picture" onclick="album_id('${album_id}')" data-toggle="modal" data-target="#tracklistModal">`;
